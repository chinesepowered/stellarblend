        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-xl font-bold text-gray-900">
              {isMainnet ? 'Available Blend Pools' : 'Blend Pools'}
            </h2>
            <p className="text-gray-600">
              {isMainnet 
                ? 'Production pools deployed on Stellar mainnet' 
                : 'Available pools on Stellar testnet'
              }
            </p>
          </div>
        ...
        <div className="text-center py-8">
          {isMainnet ? (
            ...
            <>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Pools Temporarily Unavailable</h3>
              <p className="text-gray-600">
                Testnet pools are temporarily unavailable. Please try again later.
              </p>
            </>
          )}
        </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mb-2">
                  Connected to Stellar Testnet for safe development and testing. 
                  All transactions use test network tokens.
                </p>
                <p className="text-xs text-blue-600">
                  Deploy additional pools using: <a href="https://github.com/blend-capital/blend-utils" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-800">blend-utils</a>
                </p>
              </div>
            </div>
          </div>
                  ...
                  {isMainnet ? (
                    ...
                    <>
                      <button 
                        ...
                        title="Connect wallet to interact with testnet pools"
                      >
                        Supply
                      </button>
                      <button 
